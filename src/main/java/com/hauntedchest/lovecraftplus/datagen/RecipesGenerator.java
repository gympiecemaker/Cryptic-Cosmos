...
public class RecipesGenerator extends RecipeProvider {
    ...
    public void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(ItemHandler.HUMMING_OBSIDIAN_ITEM.get(), 1)
                ...
                .addCriterion("has_humming_ingot", hasItem(ItemHandler.HUMMING_INGOT.get()))
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ItemHandler.MOON_PLANKS_ITEM.get(), 4)
                ...
                .setGroup("planks")
                .addCriterion("has_moon_log", hasItem(ItemHandler.MOON_LOG_ITEM.get()))
        ...
        ShapelessRecipeBuilder.shapelessRecipe(ItemHandler.THORN_PLANKS_ITEM.get(), 4)
                ...
                .setGroup("planks")
                .addCriterion("has_thorn_log", hasItem(ItemHandler.THORN_LOG_ITEM.get()))
        ...
        CookingRecipeBuilder.smeltingRecipe(
                ...
                0.75f,
                400)
                .addCriterion("has_humming_stone", hasItem(ItemHandler.HUMMING_STONE_ITEM.get()))
        ...
        CookingRecipeBuilder.smeltingRecipe(
                ...
                0.75f,
                400)
                .addCriterion("has_lava_sponge", hasItem(ItemHandler.LAVA_SPONGE_ITEM.get()))
    ...
    private void registerMoonstoneRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        SingleItemRecipeBuilder
                ...
                .addCriterion("has_smooth_moonstone",
                        hasItem(ItemHandler.SMOOTH_MOONSTONE_ITEM.get()))
